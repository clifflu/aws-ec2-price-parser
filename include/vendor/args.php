<?PHP
    // Ref: https://code.google.com/p/tylerhall/source/browse/trunk/class.args.php
    //
    ...
    class Args
    {
        ...
        private static $_SINGLETON_INSTANCE = null;
        ...
        public static function instance() {
            if (is_null(self::$_SINGLETON_INSTANCE))
                self::$_SINGLETON_INSTANCE = new static();
